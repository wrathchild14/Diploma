...
% Alignment code ------
    ...
    The amount of steer is calculated with the units' normalized velocity vector.
...
% Cohesion code ---------
    ...
    The amount of steer is calculated using the difference between the average position and the unit's position.
...
% Separation code ---------
    ...
    The amount of steer is calculated with the normalized average direction from all of the neighborhooding boids from a certain radius.
\end{itemize}
